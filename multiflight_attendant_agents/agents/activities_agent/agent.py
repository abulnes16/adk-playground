...
activities_agent = Agent(
    ...
    description="Suggeests interesting activities for the user at a destination",
    instruction= (
        "Given a destination, dates and budget, suggest 2-3 engaging tourist or cultural activites"
        "For each activity, provide a name, a shot description, price estimate, and duration in hours. "
